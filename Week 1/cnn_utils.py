...
def load_happy_dataset(path_train, path_test):
    """
    Load the happy house dataset.

    Arguments:
    path_train -- path of the training dataset
    path_test -- path of the testing dataset

    Returns:
    original training and test set and the number of classes
